...
Serving Monroe, NC and all of Union County.`,
  ...
  await Service.updateOne({ slug: 'taquiza-a-domicilio' }, { $set: taquizaContent });
  console.log('Updated Taquiza');

  await Service.updateOne({ slug: 'banquete-completo' }, { $set: banqueteContent });
  console.log('Updated Banquete');
